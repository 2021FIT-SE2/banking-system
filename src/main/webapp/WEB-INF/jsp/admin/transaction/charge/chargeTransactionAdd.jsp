                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">Add A New Charge Transaction</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Add Charge Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material">
                                                        ...
                                                        <div class="form-group form-default">
                                                            <input type="number" name="redeemAmount" class="form-control">
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Redeem Amount</label>
                                                        </div>
                                                        <div class="button">
