                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">List of Transfer Transactions</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Manage Transaction</a>
                                        </li>
                                        <li class="breadcrumb-item"><a href="#!">Transaction List</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="page-body">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>List of Transfer Transactions</h5>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <c:forEach var="transfer" items="${listTransfer}">
                                                        <tr>
                                                            ...
                                                            <td><c:out value="${transfer.transactionId}"></c:out></td>
                                                            <td><c:out value="${transfer.customerId}"></c:out></td>
                                                            <td><c:out value="${transfer.transferAmount}"></c:out></td>
                                                            <td><c:out value="${transfer.beneficialAccount}"></c:out></td>
                                                            <td><c:out value="${transfer.status}"></c:out></td>

                                                            <td><a href="customer-details?customerId=<c:out value='${transfer.transactionId}' /> "><i class="fas fa-info-circle"></i>Details</a></td>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;<a href="customer-delete?customerId=<c:out value='${transfer.transactionId}' /> "><i class="fas fa-trash-alt"></i>Delete</a>
