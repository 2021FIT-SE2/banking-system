                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">List of Charge Transactions</h3>
                                ...
                                <div class="page-body">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>List of Charge Transactions</h5>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <c:forEach var="charge" items="${listCharge}">
                                                        <tr>
                                                            ...
                                                            <td><c:out value="${charge.chargeAmount}"></c:out></td>

                                                            <td>
                                                                <a href="customer-details?customerId=<c:out value='${charge.transactionId}' /> "><i
                                                                        class="fas fa-info-circle"></i>Details</a></td>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                href="customer-delete?customerId=<c:out value='${charge.transactionId}' /> "><i
