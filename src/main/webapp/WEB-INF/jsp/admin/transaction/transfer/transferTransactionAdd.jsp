                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">Add A New Transfer Transaction</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Add Transfer Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material">
                                                        <div class="form-group form-default">
                                                            <input type="number" name="transactionId" class="form-control" disabled>
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Transaction ID</label>
                                                        </div>
                                                        <div class="form-group form-default">
                                                        ...
                                                        <div class="form-group form-default">
                                                            <input type="number" name="transferAmount" class="form-control">
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Transfer Amount</label>
                                                        </div>
                                                        <div class="form-group form-default">
                                                            <input type="number" name="beneficialAccount"
                                                                   class="form-control">
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Beneficial Account</label>
                                                        </div>
                                                        <div class="form-group form-default">
