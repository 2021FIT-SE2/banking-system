                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">List of Withdraw Transactions</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Withdraw Transaction List</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="page-body">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>List of Withdraw Transactions</h5>
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                    <c:forEach var="withdraw" items="${listWithdraw}">
                                                        <tr>
                                                            <td><c:out value="${withdraw.transactionId}"></c:out></td>
                                                            <td><c:out value="${withdraw.customerId}"></c:out></td>
                                                            <td><c:out value="${withdraw.withdrawAmount}"></c:out></td>

                                                            <td><a href="customer-details?customerId=<c:out value='${withdraw.transactionId}' /> "><i class="fas fa-info-circle"></i>Details</a></td>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;<a href="customer-delete?customerId=<c:out value='${withdraw.transactionId}' /> "><i class="fas fa-trash-alt"></i>Delete</a>
