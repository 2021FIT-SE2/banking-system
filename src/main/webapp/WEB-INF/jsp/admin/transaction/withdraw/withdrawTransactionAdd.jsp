                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">Add A New Withdraw Transaction</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Add Withdraw Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material">
                                                        ...
                                                        <div class="form-group form-default">
                                                            ...
                                                            <span class="form-bar"></span>
                                                            <label class="float-label">Withdraw Amount</label>
                                                        </div>
                                                        <div class="button">
