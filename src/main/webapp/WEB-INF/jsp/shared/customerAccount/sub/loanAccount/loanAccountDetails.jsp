                        ...
                        <div class="row gutters" style="margin-bottom: 10px">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <fieldset class="form-group">
                                    ...
                                    <form:input type="text" class="form-control" path="loanDuration"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <fieldset class="form-group">
                                    ...
                                    <form:input type="text" class="form-control" path="currentLoan"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <fieldset class="form-group">
                                    ...
                                    <fmt:parseDate value="${loanAccount.createdAt}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedCreatedAt" type="both"/>
