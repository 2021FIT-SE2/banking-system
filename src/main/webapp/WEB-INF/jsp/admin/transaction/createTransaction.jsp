                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h3 class="m-b-10">Add A New Transaction</h3>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Add Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form class="form-material">
                                                        ...
                                                        <div class="form-group form-default">
                                                            <label class="col-sm-8 col-form-label">Type of
                                                                Account</label>
                                                            <div class="col-sm-12">
                                                                <select name="select" class="form-control"
                                                                        name="transactionType">
                                                                    <option value="transferTransactionAdd.jsp">Transfer Transaction
                                                                    </option>
                                                                    <option value="savingAccount">Withdraw Transaction
                                                                    </option>
                                                                    <option value="loanAccount">Charge Transaction</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="button">
